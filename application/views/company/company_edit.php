    ...
    <div class="row" id="company_create_page">
        <div class="col-md-12">
            <section class="panel panel-featured">
                ...
                <form action="<?php echo $this->config->item('link_company_edit').'?id='.$id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                    ...
                    <footer class="panel-footer">
                        <input type="submit" class="btn btn-primary" name="submit" value="Ubah" id="submit_company" />
