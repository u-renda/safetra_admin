<section role="main" class="content-body">
    ...
    <!-- start: page -->
    <div class="row" id="article_edit_page">
        <div class="col-md-12">
            <section class="panel panel-featured">
                <header class="panel-heading">
                    <h2 class="panel-title">Article Edit</h2>
                </header>
                <form action="<?php echo $this->config->item('link_article_edit').'?id='.$id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                    ...
                    <footer class="panel-footer">
                        <input type="submit" class="btn btn-primary" name="submit" value="Update" id="submit_article_edit" />
                    </footer>
                </form>
            </section>
        </div>
