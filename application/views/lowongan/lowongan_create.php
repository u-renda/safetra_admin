<section role="main" class="content-body">
    ...
    <!-- start: page -->
    <div class="row" id="lowongan_create_page">
        <div class="col-md-12">
            <section class="panel panel-featured">
                <header class="panel-heading">
                    <h2 class="panel-title">Tambah Baru</h2>
                </header>
                <form action="<?php echo $this->config->item('link_lowongan_create'); ?>" method="post" class="form-horizontal form-bordered">
                    ...
                    <footer class="panel-footer">
                        <input type="submit" class="btn btn-primary" name="submit" value="Tambah" id="submit_lowongan_create" />
