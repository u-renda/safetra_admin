    ...
    <div class="row" id="client_create_page">
        <div class="col-md-12">
            <section class="panel panel-featured">
                ...
                <form action="<?php echo $this->config->item('link_client_edit').'?id='.$id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="client_url" class="form-control" value="<?php echo set_value('client_url', $result->client_url); ?>">
                            </div>
                        </div>
                    </div>
                    <footer class="panel-footer">
                        <input type="submit" class="btn btn-primary" name="submit" value="Ubah" id="submit_client" />
